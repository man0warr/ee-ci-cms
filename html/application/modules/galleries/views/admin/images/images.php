<div class="box">
    <div class="heading">
        <h1><img alt="" src="<?php echo theme_url('assets/images/icons/gallery-images.png'); ?>"> <?php echo $Gallery->title; ?> (#<?php echo $Gallery->id; ?>) &ndash; Images</h1>
...
$(document).ready(function() {
    ...
    $('#add_image').click( function() {
        ...
        window.open('<?php echo site_url('/application/themes/admin/assets/js/kcfinder/browse.php?type=images'); ?>',
