...
<div class="box">
	<div class="heading">
		<h1><img alt="" src="<?php echo theme_url('assets/images/icons/entries.png'); ?>"> Entry Edit <?php echo ($edit_mode) ? '- ' . $Entry->title . ' (#' . $Entry->id . ')' : ''; ?></h1>
	...
	<div class="content">
		...
		<?php if ( $edit_mode && $Entry->slug != '' ): ?>
			<a style="float: right; z-index: 1; position: relative; margin-top: -6px;" target="_blank" href="<?php echo site_url("$Entry->slug"); ?>"><img src="<?php echo theme_url('assets/images/icons/preview.png') ?>" width="32px" height="32px" /></a>
		<?php endif; ?>
		...
		<div class="tabs">
			...
			<div id="content-tab">
				<div id="entry_fields">
					<div>
						<?php echo form_label('<div class="arrow arrow_expand"></div>URL', 'slug'); ?>
						<span style="padding-left:20px;line-height: 24px; "> <?php echo base_url(); ?> </span>
			...
			<?php if ( $Content_type->enable_versioning ): ?>
				<div id="revisions-tab">
					<?php $Entry->entry_revisions->order_by('id', 'desc')->get();
					$r = $Entry->entry_revisions->result_count(); ?>
					<table class="list">
						<thead>
							<tr>
								<th>Revision</th>
