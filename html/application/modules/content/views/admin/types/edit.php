...
<div class="box">
    <div class="heading">
        <h1><img alt="" src="<?php echo theme_url('assets/images/icons/content-types.png'); ?>">Content Type Edit - <?php echo $Content_type->title; ?> (<?php echo $Content_type->short_name; ?>)</h1>
        ...
        <div>
            ...
            <div id="tabs">
                <ul class="htabs">
                    ...
                    <li><a href="#page-foot-tab">Page &lt;foot&gt;</a></li>
                ...
                <div id="page-foot-tab">
                    <p class="info">Include custom JavaScript just before the closing <strong>&lt;body&gt;</strong> tag of this content type's pages.</p>

                    <?php echo form_textarea(array('name'=>'page_foot', 'id'=>'page_foot', 'value'=>set_value('page_foot', !empty($Content_type->page_foot) ? $Content_type->page_foot : ''))); ?>
                </div>
                <div id="settings-tab">
                    <div class="form">
                        <div>
...
<script>
    ...
    var editor = CodeMirror.fromTextArea(document.getElementById("page_foot"), {
        lineNumbers: true,
        matchBrackets: true,
        mode: "application/x-httpd-php",
        indentUnit: 4,
