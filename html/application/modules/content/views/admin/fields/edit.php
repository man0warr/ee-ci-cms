...
<div class="box">
    <div class="heading">
        <?php if ($edit_mode): ?>
            <h1><img alt="" src="<?php echo theme_url('assets/images/icons/fields.png'); ?>">Field Edit - <?php echo $Field->label; ?></h1>
        <?php else: ?>
            <h1><img alt="" src="<?php echo theme_url('assets/images/icons/fields.png'); ?>">Field Add</h1>
        <?php endif; ?>
