<div class="box">
    <div class="heading">
        <h1><img alt="" src="<?php echo theme_url('assets/images/icons/user-groups.png'); ?>"> User Groups</h1>
...
<script type="text/javascript">
    $(document).ready( function() {
        ...
        $('.delete').click( function() {
            ...
            {
                $('#form').attr('action', '<?php echo site_url(ADMIN_PATH . '/users/groups/delete'); ?>').submit();
            }
            else
            {
                return false;
