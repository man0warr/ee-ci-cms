 ...
 * Time Elapsed String
 *
 * Converts a literal time stamp into a textual sentense
 * describing the time since the timestamp.
 * Eg: "2013-06-02 24:34:22" -> "2 hours ago"
 *
 * @param string
 * @return string
 */
 ...
 * EE Url
 *
 * Create a url to the Einstein's Eyes Website
 *
 * @param string
 * @return string
 */
if ( ! function_exists('ee_url'))
{
    function ee_url()
    {
        return '<a href="http://www.einsteinseyes.com/what-we-do/web-design" target="_blank">Dallas Web Design</a> by Einstein\'s Eyes</p>';
    }
}
