...
class Template
{
     ...
     * @return object
     */
    function add_javascript($javascripts, $foot = FALSE)
    {
     ...
     * @return object
     */
    function add_script($scripts, $foot = FALSE)
    {
        if ( ! is_array($scripts))
        {
     ...
     * Add Page Foot
     *
     * Used to include custom JavaScript immediately before the closing </body> tag
     *
     * @param string
     * @return object
     */
    function add_page_foot($code)
    {
        if (is_string($code))
        {
            $this->page_foot = $code;
     ...
     * @return string
     */
    function javascripts($foot = FALSE)
    {
        if ($foot)
        {
     ...
     * Outputs the foot javascripts defined in the content type
     *
     * @return string
     */
    function page_foot()
