...
class Settings
{
    ...
    function __get($slug)
    {
        // When not in production mode, the notification email can be overridden by the developers email
        if ($slug == 'notification_email' && ENVIRONMENT != 'production' && $this->use_developers_email)
        {
            $slug = 'developers_email';
        }
